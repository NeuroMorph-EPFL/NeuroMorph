#    NeuroMorph_Naming.py (C) 2019,  Anne Jorstad
#
...
bl_info = {  
    ...
    "version": (1, 1, 0),
    "blender": (2, 80, 0),
    "location": "View3D > NeuroMorph > Object Naming Convention",
    "description": "Interface for NeuroMorph naming convention",
    "wiki_url": "https://github.com/NeuroMorph-EPFL/NeuroMorph/wiki/Other-Tools#neuromorph-naming",    
    "category": "Tool"}  
...
class NEUROMORPH_PT_NamingPanel(bpy.types.Panel):
    bl_idname = "NEUROMORPH_PT_NamingPanel"
    ...
    def draw(self, context):
        ...
        if obj is not None:
            ...
            layout.operator("neuromorph.update_name", text = "Update Object Name")
            global_name = this_name


# update name of already existing object
class NEUROMORPH_OT_update_name(bpy.types.Operator):
    """Change name of object"""
    bl_idname = "neuromorph.update_name"
...
classes = (
    NEUROMORPH_PT_NamingPanel,
    NEUROMORPH_OT_update_name
)
